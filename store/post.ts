...
// optional because later we will use it in reducer and default state cannot be any post yet,
// thus we will define it as null.
...
export const post = (state: PostState = null, action: PostAction) => {
    switch (action.type) {
        ...
        case UPDATE_POST_ACTION: return action.post
